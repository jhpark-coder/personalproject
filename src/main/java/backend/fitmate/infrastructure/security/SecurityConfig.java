package backend.fitmate.infrastructure.security;
...
import backend.fitmate.infrastructure.security.oauth.CustomOAuth2UserService;
import backend.fitmate.infrastructure.security.oauth.CustomOidcUserService;
...
import backend.fitmate.domain.user.service.CustomUserDetailsService;
import jakarta.servlet.http.HttpServletRequest;
import jakarta.servlet.http.HttpServletResponse;
import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import backend.fitmate.infrastructure.security.jwt.JwtAuthenticationFilter;
import backend.fitmate.common.filter.CalendarLinkingLoggingFilter;
import backend.fitmate.infrastructure.security.oauth.CustomAuthorizationRequestResolver;
...
public class SecurityConfig {
    ...
    private OAuth2LoginAuthenticationFilter createCalendarOAuth2Filter() {
        ...
        // Spring Security 6에서는 RequestMatcher를 직접 사용
        calendarFilter.setRequiresAuthenticationRequestMatcher(
            request -> request.getServletPath().startsWith("/connect/oauth2/code/")
        );
