...
public interface WorkoutSessionRepository extends JpaRepository<WorkoutSession, Long> {
    ...
    /**
     * 특정 날짜 이후의 사용자 세션 조회 (최신순 정렬)
     */
    List<WorkoutSession> findByUserAndSessionDateAfterOrderBySessionDateDesc(User user, LocalDateTime fromDate);

    /**
     * 사용자별 특정 기간 내 세션 조회
     */
    List<WorkoutSession> findByUserAndSessionDateBetween(User user, LocalDateTime startDate, LocalDateTime endDate);
}