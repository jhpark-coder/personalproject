...
export class NotificationsController {
  ...
  async createNotification(@Body() createNotificationDto: CreateNotificationDto) {
    ...
    if (createNotificationDto.targetUserId) {
      this.notificationsGateway.sendNotificationToUser(createNotificationDto.targetUserId, savedNotification);
    }
  ...
  async createAdminNotification(@Body() createNotificationDto: CreateNotificationDto) {
    const savedNotification = await this.notificationsService.createNotification(createNotificationDto);
    this.notificationsGateway.sendNotificationToAdminGroup(savedNotification);
