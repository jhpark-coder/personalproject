-- Enable local infile for this session (may be ignored if server disallows)
...
-- 2) Load CSV (run from the repository root; adjust if your local path differs)
LOAD DATA LOCAL INFILE 'apps/backend/src/main/resources/exercises_seed.csv'
